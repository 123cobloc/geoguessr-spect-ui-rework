...
| :--- | :--- | :--- |
| **Chrome / Brave / Opera** | **Tampermonkey** | [Install from Chrome Web Store](https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo) |
| **Firefox** | **Tampermonkey** | [Install from Firefox Add-ons](https://addons.mozilla.org/en-US/firefox/addon/tampermonkey/) |
| **Edge** | **Tampermonkey** | [Install from Microsoft Store](https://microsoftedge.microsoft.com/addons/detail/tampermonkey/iikmkjmpaadaobahmlepeloendndfphd) |
| **Safari (Mac/iOS)** | **Userscripts** | [Install from App Store](https://apps.apple.com/us/app/userscripts/id1463298887) |
